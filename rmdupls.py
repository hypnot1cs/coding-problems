...
#  Returns the number of non duped items in a list (k), the first k letters should be the non duped array
# By hypnotics; Started on Completed on
# File Type: LeetCode Problem @ https://leetcode.com/problems/remove-duplicates-from-sorted-array/
